...
- Hearthstone: `GetBindLocation()` returns a name. Map names to nodes how?
  Include the cooldown check?
- Class/faction travel (mage teleports and portals, druid Moonglade,
  warlock summons): in or out? Proposed: out of v1.
