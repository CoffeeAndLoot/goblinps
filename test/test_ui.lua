...
return function(h)
    ...
    h.describe("the settings panel", function()
        ...
        h.it("offers the Wago page as a copyable address for feedback", function()
            local ui = Settings.Debug()
            h.eq(Settings.FEEDBACK_URL, "https://addons.wago.io/addons/goblinps")
            h.eq(ui.feedback:GetText(), "Feedback: copy this address and leave a comment there.")
