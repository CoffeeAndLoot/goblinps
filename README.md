...
**The Goblin Positioning System, for WoW Forever.** Less walkin'. More earnin'.

Tell it where you want to go and it works out the fastest way there from where
you stand, then guides you step by step. Spend less time alt-tabbing to a map
site, riding the wrong way out of the Barrens, or making expensive introductions
to enemy guards.
...
is it worth burning the hearthstone? GoblinPS does the sums. You handle the loot.
...
- **Time is money. Save some.** Every route weighs the flight paths *this
...
- **Leave the directions to the gadget.** Start Route turns the planner into a pocket navigator:
...
- **Avoid costly introductions.** Zones above your level are flagged in amber, and
...
- **Know a shortcut? We might.** When a flight path you
...
steps, and how long is left. Save the scenic detour for somebody on salary.
...
Ideas, not delivery promises. Even goblin engineering takes a little time:
...
Found a bad route or a loose bolt? Tell us where the machinery went wrong.
